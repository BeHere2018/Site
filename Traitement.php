...
if( isset($_POST['mail']) && isset($_POST['idbiere']) && isset($_POST['Note']) )
{
    ...
    if($_POST['mail']=="Anonymous"){
        put_rate(0,$_POST['idbiere'],$_POST['Arome'],$_POST['Gout'],$_POST['Palais'],$_POST['Apparence'],$_POST['Note']);
        include 'Anonyme.php';
    }else{
        ...
        put_rate($P[0],$_POST['idbiere'],$_POST['Arome'],$_POST['Gout'],$_POST['Palais'],$_POST['Apparence'],$_POST['Note']);
